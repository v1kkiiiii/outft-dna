/**
 * aesthetic-taxonomy-v2 definitions and family groupings.
 *
 * Single source of truth for what each of the 478 canonical aesthetic
 * labels (AESTHETIC_TAXONOMY_V1 in schema.ts) actually means. Used to build
 * the definition-annotated prompt text in prompt.ts, so the model has real
 * disambiguating signal between visually or conceptually similar labels
 * (e.g. "Quiet luxury" vs "Stealth wealth" vs "Old money") instead of bare
 * names. Must stay in sync with AESTHETIC_TAXONOMY_V1 — validated by
 * scripts/verify-aesthetic-definitions at CI time is a future improvement;
 * for now, keep additions to both files paired in the same change.
 */

import type { AestheticLabel } from './schema.js';

export interface AestheticFamily {
  name: string;
  labels: AestheticLabel[];
}

export const AESTHETIC_FAMILIES: AestheticFamily[] = [
  { name: 'LUXURY / HIGH FASHION', labels: ['Quiet luxury', 'Old money', 'New money', 'Stealth wealth', 'Power dressing', 'Haute couture', 'Designer logomania', 'Italian luxury', 'French chic', 'Paris street', 'Milan sleek', 'Archive fashion', 'Fashion week', 'Editorial', 'Avant garde', 'Conceptual fashion', 'Deconstructed', 'Asymmetric', 'Sculptural', 'Couture gown'] },
  { name: 'CLEAN / MINIMAL', labels: ['Minimalist', 'Classic minimalist', 'Scandi', 'Danish cool', 'Normcore', 'Clean girl', 'Vanilla girl', 'Classic', 'Timeless', 'Understated', 'Monochrome', 'Tonal dressing', 'All black', 'All white', 'Neutral palette', 'Capsule wardrobe', 'Effortless chic', 'Undone elegance', 'Quiet cool', 'Raw edge minimal'] },
  { name: 'PREPPY / CLASSIC AMERICAN', labels: ['Preppy', 'East coast prep', 'Ivy league', 'Old school prep', 'WASP aesthetic', 'Country club', 'Tennis core', 'Lacrosse casual', 'Varsity', 'Letterman', 'Rowing aesthetic', 'Sailing', 'Equestrian', 'Polo', 'Rugby stripe', 'Madras', 'Nantucket red', 'New England casual', 'Coastal grandmother', 'Hamptons'] },
  { name: 'STREETWEAR / URBAN', labels: ['Streetwear', 'Hypebeast', 'Sneakerhead', 'Techwear', 'Gorpcore', 'Utilitarian', 'Cargo', 'Workwear', 'NY street', 'LA street', 'London street', 'Tokyo street', 'Paris street casual', 'Chicago casual', 'ATL street', 'Miami street', 'Skater', 'Longboarder', 'BMX', 'Graffiti culture', 'Underground', 'Off duty model', 'Model off duty', 'Airport fit', 'Travel casual'] },
  { name: 'SPORTY / ATHLETIC', labels: ['Athleisure', 'Gymwear', 'Running aesthetic', 'Pilates girl', 'Yoga casual', 'Cyclist', 'Swimmer casual', 'Soccer casual', 'Basketball casual', 'Golf casual', 'Ski chalet', 'Apres ski', 'Surf', 'Wakeboard', 'Outdoorsy active', 'Hiker', 'Climber', 'Lux sport', 'Sporty chic', 'Sport luxe', 'Blokecore', 'Football casual', 'Terrace wear'] },
  { name: 'COASTAL / NATURE', labels: ['Beach casual', 'Island girl', 'Tropical', 'Surf girl', 'Ocean aesthetic', 'Mermaidcore', 'Nautical', 'Maritime', 'Coastal cool', 'California casual', 'Santa Barbara', 'Malibu', 'Mediterranean', 'Greek island', 'Amalfi coast', 'Tulum', 'Bali', 'Nature girl', 'Outdoorsy', 'Camping chic', 'Cottagecore', 'Farmcore', 'Prairie', 'Western', 'Cowboy', 'Cowgirl', 'Country', 'Southern belle', 'Rancher', 'Desert aesthetic', 'Southwestern', 'Boho western'] },
  { name: 'FEMININE / ROMANTIC', labels: ['Coquette', 'Balletcore', 'Soft girl', 'Princesscore', 'Fairycore', 'Angelcore', 'Ethereal', 'Dreamy', 'Whimsical', 'Romantic', 'Dark romance', 'Regencycore', 'Royalcore', 'Cottagecore romantic', 'Floral feminine', 'Lace and ribbon', 'Bow aesthetic', 'Vintage feminine', 'Old Hollywood glam', 'Pin-up', 'Bombshell', 'Femme fatale', 'Burlesque', 'Cabaret', 'Showgirl'] },
  { name: 'DARK / ALTERNATIVE', labels: ['Goth', 'Gothic', 'Dark academia', 'Grunge', 'Punk', 'Soft punk', 'Pop punk', 'Cyber goth', 'Industrial', 'Witchcore', 'Witchy academic', 'Occult', 'Victorian goth', 'Edwardian goth', 'Romantic goth', 'Pastel goth', 'Nu goth', 'Whimsigoth', 'Cryptidcore', 'Weirdcore', 'Dreamcore', 'Traumacore', 'Dariacore', 'Grunge lite', 'Edgy minimalist', 'Dark minimalist', 'Shadow'] },
  { name: 'RETRO / VINTAGE', labels: ['Y2K', '90s', '80s', '70s boho', '70s disco', '60s mod', '50s housewife', '50s rockabilly', '40s wartime', '30s glamour', '20s flapper', 'Disco', 'Glam rock', 'Hair metal', 'New wave', 'Post punk', 'Mod revival', 'Teddy boy', 'Greaser', 'Psychedelic', 'Hippie', 'Flower child', 'Free love era', 'Thriftcore', 'Vintage prep', 'Archive hunting', 'Deadstock', 'Retro sporty'] },
  { name: 'CREATIVE / ARTSY', labels: ['Art hoe', 'Eclectic', 'Maximalist', 'Color blocking', 'Print mixing', 'Pattern clash', 'Dopamine dressing', 'Joy dressing', 'Camp', 'Kitsch', 'Pop art', 'Surrealist fashion', 'Dadaist', 'Bauhaus', 'Abstract', 'Artist aesthetic', 'Painter', 'Ceramicist', 'Gallery girl', 'Museum aesthetic'] },
  { name: 'ACADEMIC', labels: ['Light academia', 'Academia', 'Oxford aesthetic', 'Cambridge aesthetic', 'Bookish', 'Literary', 'Philosopher', 'Professor', 'Student aesthetic', 'Scholastic', 'Classic academic', 'Science nerd', 'Math aesthetic', 'Art student', 'Film student', 'Theater kid', 'Music student', 'Architecture student', 'Law school'] },
  { name: 'JAPANESE SUBCULTURES', labels: ['Gyaru', 'Kogal', 'Lolita', 'Sweet Lolita', 'Gothic Lolita', 'Classic Lolita', 'Punk Lolita', 'Sailor Lolita', 'Wa Lolita', 'Mori girl', 'Visual kei', 'Decora', 'Fairy kei', 'Gyaru-o', 'Harajuku', 'Shibuya casual', 'Ura-Harajuku', 'Kigurumi', 'Dolly kei', 'Cult party kei', 'Larme kei', 'Jirai kei', 'Yami kawaii', 'Kawaii', 'Super kawaii', 'Pastel kawaii', 'Dark kawaii'] },
  { name: 'KOREAN', labels: ['K-fashion', 'K-indie', 'K-pop idol', 'Soft Seoul', 'K-street', 'Ulzzang', 'Hanbok fusion', 'Korean minimal', 'Seoul casual', 'Hongdae street', 'Sinchon style', 'Korean office', 'K-beauty adjacent'] },
  { name: 'CHINESE', labels: ['C-fashion', 'Hanfu', 'Tang aesthetic', 'Modern hanfu', 'Chinese streetwear', 'Shanghai chic', 'Beijing casual', 'C-pop idol'] },
  { name: 'SOUTH ASIAN', labels: ['Indo-fusion', 'Modern kurta', 'Saree contemporary', 'Desi street', 'Bollywood glam', 'South Asian bridal', 'Indo-western'] },
  { name: 'AFRICAN / AFRODIASPORA', labels: ['Afrocentric', 'Afrofuturist', 'Lagos street', 'Nairobi cool', 'African print', 'Ankara fashion', 'Kente inspired', 'West African glamour', 'East African minimal', 'Afropunk', 'Diaspora chic'] },
  { name: 'LATIN / LATINX', labels: ['Latin street', 'Miami Cuban', 'Colombian chic', 'Brazilian beach', 'Mexican folk inspired', 'Tejano', 'Reggaeton glam', 'Latin minimalist', 'Barrio chic'] },
  { name: 'MIDDLE EASTERN', labels: ['Gulf chic', 'Dubai glam', 'Modern abaya', 'Modest fashion', 'Levant street', 'Persian elegant', 'Arabic streetwear'] },
  { name: 'INTERNET / DIGITAL NATIVE', labels: ['Seapunk', 'Vaporwave', 'Cybercore', 'Webcore', 'Glitchcore', 'Internetcore', 'Tumblr era', 'Twitter aesthetic', 'TikTok fashion', 'Instagram aesthetic', 'Pinterest board', 'Bloggercore', 'VSCO girl', 'E-girl', 'E-boy', 'Softie', 'Alt TikTok', 'Cottagecore internet'] },
  { name: 'SUBCULTURE SPECIFIC', labels: ['Raver', 'Club kid', 'Rave aesthetic', 'Festival', 'Burning Man', 'Underground club', 'Drag inspired', 'Ballroom', 'Vogue aesthetic', 'Biker', 'Motorcycle', 'Heavy metal', 'Rock', 'Indie rock', 'Folk', 'Jazz aesthetic', 'Blues aesthetic', 'Classical music', 'Opera glam', 'Choir casual'] },
  { name: 'OCCUPATION / LIFESTYLE', labels: ['Office siren', 'Corporate baddie', 'Business casual', 'Smart casual', 'Business formal', 'Creative professional', 'Tech bro', 'Silicon Valley casual', 'Startup casual', 'Freelancer chic', 'Barista aesthetic', 'Chef casual', 'Artist studio', 'Yoga instructor', 'Personal trainer', 'Nurse off duty', 'Teacher aesthetic', 'Librarian', 'Architect', 'Interior designer'] },
  { name: 'OCCASION', labels: ['Date night', 'Night out', 'Brunch fit', 'Vacation mode', 'Resort wear', 'Cruise wear', 'Wedding guest', 'Black tie', 'Cocktail', 'Garden party', 'Baby shower', 'Birthday fit', 'Festival fit', 'Concert fit', 'Museum day', 'Gallery opening', 'Farmers market', 'Coffee run', 'Errand fit', 'Lazy day chic'] },
  { name: 'SITUATIONAL MICRO', labels: ['Tomato girl summer', 'Mob wife', 'Quiet outdoor', 'Libertine', 'Cleanfit', 'Vanilla girl summer', 'That girl', 'Lucky girl', 'Latte girl', 'Espresso girl', 'Coastal cowgirl', 'Cowboy core', 'Mermaid summer', 'Ballet flats era', 'Loafer girl', 'Sneaker girl', 'Boot season', 'Trench coat era', 'Leather jacket girl', 'Blazer girl'] },
  { name: 'SCENE / EMO ERA', labels: ['Scene', 'Emo', 'Screamo', 'Scene queen', 'Mall goth', 'Hot topic era', 'Myspace era', 'Raccoon eyes', 'Checkered pattern', 'Band tee culture'] },
  { name: 'TWEE / INDIE', labels: ['Twee', 'Hipster', 'Indie', 'Indie sleaze', 'Indie film', 'Wes Anderson aesthetic', 'Sundance', 'Folk indie', 'Bedroom pop', 'Shoegaze aesthetic'] },
  { name: 'MISCELLANEOUS NICHE', labels: ['Knightcore', 'Medievalcore', 'Renaissancecore', 'Baroque', 'Rococo', 'Victorianna', 'Edwardian', 'Art nouveau', 'Art deco', 'Futurist', 'Space age', 'Retrofuturism', 'Solarpunk', 'Lunarpunk', 'Steampunk', 'Dieselpunk', 'Atompunk', 'Biopunk', 'Cyberpunk'] },
];

export const AESTHETIC_DEFINITIONS: Record<AestheticLabel, string> = {
